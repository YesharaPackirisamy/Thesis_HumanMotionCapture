...
for i=1:1:N
    ...
    measurement=true;
    count=count*2;
%     h1 = h1_eqn(L1,L2,phi_body,psi_body,theta1,theta_body);
...
%    
    ...
    measurement=true;
    count=count+1;
%     h2 = h2_eqn(L1,L2,phi_body,psi_body,theta1,theta_body);
...
%     
    ...
    measurement=true;
    count=count*2;
%     h3 = h3_eqn(L1,L2,L3,phi_body,psi_body,theta1,theta2,theta_body);
%     H3 = H3_matrix(L1,L2,L3,theta1,theta2);
    ...
    measurement=true;
%     count=count*2;
%     h4 = h4_eqn(L1,L2,L3,phi_body,psi_body,theta1,theta2,theta_body);
...
%     measurement=true;
%     count=count+1;
% %     h5 = h5_eqn(L4,L5,phi_body,psi_body,theta1,theta_body);
...
%     measurement=true;
%     count=count+1;
% %     h6 = h6_eqn(L4,L5,phi_body,psi_body,theta1,theta_body);
...
%     end
    ...
    measurement=true;
    count=count*2;
%     h7 = h7_eqn(L4,L5,L6,phi_body,psi_body,theta1,theta2,theta_body);
%     H7 = H7_matrix(L4,L5,L6,theta1,theta2);
    ...
    measurement=true;
    count=count*2;
%     h8 = h8_eqn(L4,L5,L6,phi_body,psi_body,theta1,theta2,theta_body);
...
%     
    ...
    measurement=true;
    count=count*2;
%     h9 = h9_eqn(L1,L7,phi_body,psi_body,theta3,theta_body);
...
%     
    ...
    measurement=true;
    count=count*2;
%     h11 = h11_eqn(L1,L7,L8,phi_body,psi_body,theta3,theta4,theta_body);
%     H11 = H11_matrix(L1,L7,L8,theta3,theta4);
    ...
    measurement=true;
    count=count*2;
%     h12 = h12_eqn(L1,L7,L8,phi_body,psi_body,theta3,theta4,theta_body);
...
%     measurement=true;
%     count=count+1;
% %     h13 = h13_eqn(L4,L9,phi_body,psi_body,theta3,theta_body);
...
%     measurement=true;
%     count=count+1;
% %     h14 = h14_eqn(L4,L9,phi_body,psi_body,theta3,theta_body);
...
%     end
    ...
    measurement=true;
    count=count*2;
%     h15 = h15_eqn(L4,L9,L10,phi_body,psi_body,theta3,theta4,theta_body);
%     H15 = H15_matrix(L4,L9,L10,theta3,theta4);
    ...
    measurement=true;
    count=count*2;
%     h16 = h16_eqn(L4,L9,L10,phi_body,psi_body,theta3,theta4,theta_body);
...
figure(5);
stairs(filterStates(5,:));
hold on;
%plot(theta_cam(:,1));
title('Graph showing Velocity (theta1) tracked with EKF');
xlabel('Sample time'); % x-axis label
ylabel('rad');
...
hold on;
%plot(theta_cam(:,1));
title('Graph showing Velocity (theta3) tracked with EKF');
xlabel('Sample time'); % x-axis label
ylabel('rad/s');
legend('filterStates','Location','northeast');
...
% hold on;
% %plot(rad2deg(phi_cam_left(:,1)));
% title('Graph showing dtheta residual in y');
% xlabel('Sample time'); % x-axis label
% ylabel('angle');
